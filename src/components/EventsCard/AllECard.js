...
const EventCard =({eventId})=>{
    ...
    return(
        ...
        OorH={eventDate.OorH}
        listpeople={eventDate.listpeople}
...
const AllECard =()=>{
    return (
      <div >
        <div className="card-header d-sm-flex align-items-center text-center justify-content-sm-between border-0 pb-0  container ">
          <div id="Title">Discover Events</div>
          <button type="button" className="btn btn-link" id="View">
            View all events
          </button>
        </div>
